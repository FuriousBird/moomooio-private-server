...
function Br(e, t, i) {
    for (var s = t, n = s + i, r = [], o = ""; s < n;) {
        ...
        r.length >= sa && (o += String.fromCharCode.apply(String, r), r.length = 0)
    }
...
function ua(e) {
    ...
    if (t >= 0 && i >= 0 && t <= fa)
        ...
        var s = new Uint8Array(12),
            n = new DataView(s.buffer);
        return n.setUint32(0, i), Rr(n, 4, t), s
    }
}
...
var ya = {
    ...
    zr = function() {
        function e() {
            this.builtInEncoders = [], this.builtInDecoders = [], this.encoders = [], this.decoders = [], this.register(ya)
        }
...
var ka = 100,
    ...
    xa = function() {
        function e(t, i, s, n, r, o, l, c) {
            t === void 0 && (t = zr.defaultCodec), i === void 0 && (i = void 0), s === void 0 && (s = ka), n === void 0 && (n = va), r === void 0 && (r = !1), o === void 0 && (o = !1), l === void 0 && (l = !1), c === void 0 && (c = !1), this.extensionCodec = t, this.context = i, this.maxDepth = s, this.initialBufferSize = n, this.sortKeys = r, this.forceFloat32 = o, this.ignoreUndefined = l, this.forceIntegerToFloat = c, this.pos = 0, this.view = new DataView(new ArrayBuffer(this.initialBufferSize)), this.bytes = new Uint8Array(this.view.buffer)
        }
        return e.prototype.reinitializeState = function() {
            ...
            if (s > ea) {
                var n = Es(t);
                this.ensureBufferSizeToWrite(i + n), this.writeStringHeader(n), na(t, this.bytes, this.pos), this.pos += n
            } else {
                var n = Es(t);
                this.ensureBufferSizeToWrite(i + n), this.writeStringHeader(n), jo(t, this.bytes, this.pos), this.pos += n
            }
            ...
            this.ensureBufferSizeToWrite(8), Qo(this.view, this.pos, t), this.pos += 8
        }, e.prototype.writeI64 = function(t) {
            this.ensureBufferSizeToWrite(8), Rr(this.view, this.pos, t), this.pos += 8
        }, e
    }();
...
var ba = 16,
    ...
    Ta = function() {
        function e(t, i) {
            t === void 0 && (t = ba), i === void 0 && (i = Sa), this.maxKeyLength = t, this.maxLengthPerKey = i, this.hit = 0, this.miss = 0, this.caches = [];
    ...
    Aa = function() {
        function e(t, i, s, n, r, o, l, c) {
            t === void 0 && (t = zr.defaultCodec), i === void 0 && (i = void 0), s === void 0 && (s = Ke), n === void 0 && (n = Ke), r === void 0 && (r = Ke), o === void 0 && (o = Ke), l === void 0 && (l = Ke), c === void 0 && (c = Ca), this.extensionCodec = t, this.context = i, this.maxStrLength = s, this.maxBinLength = n, this.maxArrayLength = r, this.maxMapLength = o, this.maxExtLength = l, this.keyDecoder = c, this.totalPos = 0, this.pos = 0, this.view = Zn, this.bytes = Pa, this.headByte = Dt, this.stack = []
        }
        return e.prototype.reinitializeState = function() {
            this.totalPos = 0, this.headByte = Dt, this.stack.length = 0
        }, e.prototype.setBuffer = function(t) {
            this.bytes = gi(t), this.view = wa(this.bytes), this.pos = 0
                ...
                return Ji(this, function(w) {
                    switch (w.label) {
                        case 0:
                            o = !1, w.label = 1;
                        case 1:
                            w.trys.push([1, 6, 7, 12]), i = Ps(t), w.label = 2;
                        case 2:
                            return [4, i.next()];
                        case 3:
                ...
                return Ji(this, function(m) {
                    switch (m.label) {
                        case 0:
                            n = i, r = -1, m.label = 1;
                        case 1:
                            m.trys.push([1, 13, 14, 19]), o = Ps(t), m.label = 2;
                        case 2:
                            return [4, St(o.next())];
                        case 3:
                        ...
                        case 8:
                            return [3, 10];
                        case 9:
                            if (a = m.sent(), !(a instanceof Pn)) throw a;
                            return [3, 10];
                        case 10:
            ...
            e: for (;;) {
                ...
                for (var r = this.stack; r.length > 0;) {
                    ...
                    if (o.type === 0)
                        ...
                        if (!Ea(i)) throw new Pe("The type of key must be string or number but " + typeof i);
            ...
            if (this.bytes.byteLength < this.pos + i + t) throw Cs;
            var n = this.pos + i,
                r;
            return this.stateIsMapKey() && (!((s = this.keyDecoder) === null || s === void 0) && s.canBeCached(t)) ? r = this.keyDecoder.decode(this.bytes, n, t) : t > oa ? r = aa(this.bytes, n, t) : r = Br(this.bytes, n, t), this.pos += i + t, r
            ...
            if (!this.hasRemaining(t + i)) throw Cs;
            var s = this.pos + i,
...
function Fr(e) {
    ...
    if ((Ce === Cn || !Ce) && setTimeout) return Ce = setTimeout, setTimeout(e, 0);
    try {
        return Ce(e, 0)
    } catch {
        try {
...
function Da(e) {
    ...
    if ((Ae === An || !Ae) && clearTimeout) return Ae = clearTimeout, clearTimeout(e);
    try {
        return Ae(e)
    } catch {
        try {
...
function Oa() {
    !Tt || !Qe || (Tt = !1, Qe.length ? ze = Qe.concat(ze) : ai = -1, ze.length && Vr())
}
...
function Vr() {
    if (!Tt) {
        ...
        for (var t = ze.length; t;) {
            for (Qe = ze, ze = []; ++ai < t;) Qe && Qe[ai].run();
            ai = -1, t = ze.length
        }
        Qe = null, Tt = !1, Da(e)
    }
...
le.nextTick = function(e) {
    ...
    ze.push(new Lr(e, t)), ze.length === 1 && !Tt && Fr(Vr)
};
...
const $l = Math.atan2,
    ...
    Wr = function(e, t) {
        ...
        function r(c) {
            ci(c), window.setUsingTouch(!0), i && (c.preventDefault(), c.stopPropagation()), e.onmouseover && e.onmouseover(c), s = !0
        }

        function o(c) {
            ci(c), window.setUsingTouch(!0), i && (c.preventDefault(), c.stopPropagation()), qr(e, c.pageX, c.pageY) ? s || (e.onmouseover && e.onmouseover(c), s = !0) : s && (e.onmouseout && e.onmouseout(c), s = !1)
        }

        function l(c) {
            ci(c), window.setUsingTouch(!0), i && (c.preventDefault(), c.stopPropagation()), s && (e.onclick && e.onclick(c), e.onmouseout && e.onmouseout(c), s = !1)
        }
    },
    cc = function(e) {
    ...
    hc = function(e) {
        ...
        if (t.onclick && (t.onclick = Be(t.onclick)), t.onmouseover && (t.onmouseover = Be(t.onmouseover)), t.onmouseout && (t.onmouseout = Be(t.onmouseout)), e.style && (t.style.cssText = e.style), e.hookTouch && Wr(t), e.parent && e.parent.appendChild(t), e.children)
    ...
    dc = function() {
        this.init = function(e, t, i, s, n, r, o) {
            this.x = e, this.y = t, this.color = o, this.scale = i, this.startScale = this.scale, this.maxScale = i * 1.5, this.scaleSpeed = .7, this.speed = s, this.life = n, this.text = r
        ...
        this.texts = [], this.update = function(e, t, i, s) {
            ...
            for (let c = 0; c < this.texts.length; ++c)
                if (!this.texts[c].life) {
                    l = this.texts[c];
                    break
                } l || (l = new dc, this.texts.push(l)), l.init(e, t, i, s, n, r, o)
        }
    },
    mc = function(e, t) {
        let i;
...
function yc(e, t, i, s, n, r) {
    ...
    this.add = function(h, m, w, v, x, D, k, S, O) {
        ...
        if (Ds(v) <= D || Ds(x) <= D) {
            ...
            let k = gc(v * v + x * x) - D;
            if (k <= 0) {
                if (m.ignoreCollision) m.trap && !h.noTrap && m.owner != h && !(m.owner && m.owner.team && m.owner.team == h.team) ? (h.lockMove = !0, m.hideFromEnemy = !1) : m.boostSpeed ? (h.xVel += w * m.boostSpeed * (m.weightM || 1) * Ot(m.dir), h.yVel += w * m.boostSpeed * (m.weightM || 1) * Rt(m.dir)) : m.healCol ? h.healCol = m.healCol : m.teleport && (h.x = i.randInt(0, s.mapScale), h.y = i.randInt(0, s.mapScale));
                else {
                    const S = i.getDirection(h.x, h.y, m.x, m.y);
                    if (i.getDistance(h.x, h.y, m.x, m.y), m.isPlayer ? (k = k * -1 / 2, h.x += k * Ot(S), h.y += k * Rt(S), m.x -= k * Ot(S), m.y -= k * Rt(S)) : (h.x = m.x + D * Ot(S), h.y = m.y + D * Rt(S), h.xVel *= .75, h.yVel *= .75), m.dmg && m.owner != h && !(m.owner && m.owner.team && m.owner.team == h.team)) {
...
function vc(e, t, i, s, n, r, o, l) {
    ...
    this.update = function(p) {
        if (this.active) {
            ...
            let k = !1,
                S = 1;
            if (!this.zIndex && !this.lockMove && this.y >= r.mapScale / 2 - r.riverWidth / 2 && this.y <= r.mapScale / 2 + r.riverWidth / 2 && (S = .33, this.xVel += r.waterCurrent * p), this.lockMove) this.xVel = 0, this.yVel = 0;
            ...
            const O = n.getDistance(0, 0, this.xVel * p, this.yVel * p),
                ...
                U = 1 / L;
            for (var h = 0; h < L; ++h) {
                this.xVel && (this.x += this.xVel * p * U), this.yVel && (this.y += this.yVel * p * U), w = t.getGridArrays(this.x, this.y, this.scale);
                for (var v = 0; v < w.length; ++v)
                    for (let F = 0; F < w[v].length; ++F) w[v][F].active && t.checkCollision(this, w[v][F], U)
            }
            let q = !1;
    ...
    this.animate = function(p) {
        ...
        this.animTime = this.animSpeed = 600, this.targetAngle = Math.PI * .8, a = 0, u = 0
        ...
        if (this.active && (this.health += p, m && (this.hitScare && !n.randInt(0, this.hitScare) ? (this.runFrom = m, this.waitCount = 0, this.moveCount = 2e3) : this.hostile && this.chargePlayer && m.isPlayer ? (this.chargeTarget = m, this.waitCount = 0, this.moveCount = 8e3) : this.dontRun || (this.runFrom = m, this.waitCount = 0, this.moveCount = 2e3)), p < 0 && this.hitRange && n.randInt(0, 1) && (this.hitWait = 500), h && h.canSee(this) && p < 0 && l.send(h.id, "8", Math.round(this.x), Math.round(this.y), Math.round(-p), 1), this.health <= 0)) {
            ...
            if (this.health = this.maxHealth, this.runFrom = null, h && (o(h, this.killScore), this.drop))
                for (let w = 0; w < this.drop.length;) h.addResource(r.resourceTypes.indexOf(this.drop[w]), this.drop[w + 1]), w += 2
        }
    }
}
...
function xc(e) {
    this.sid = e, this.init = function(t, i, s, n, r, o, l) {
        ...
        return t = t || 1, this.scale * (this.isItem || this.type == 2 || this.type == 3 || this.type == 4 ? 1 : .6 * t) * (i ? 1 : this.colDiv)
...
function Hc(e, t, i, s, n, r, o, l, c, a, u, p, h, m) {
    ...
    this.points = 0, this.dt = 0, this.hidden = !1, this.itemCounts = {}, this.isPlayer = !0, this.pps = 0, this.moveDir = void 0, this.skinRot = 0, this.lastPing = 0, this.iconIndex = 0, this.skinColor = 0, this.spawn = function(k) {
        ...
        if (S) {
            for (let O = 0; O < this.items.length; ++O)
                if (c.list[this.items[O]].group == S.group) return this.buildIndex == this.items[O] && (this.buildIndex = k), this.items[O] = k, !0;
        ...
        if (k) {
            this.name = "unknown";
            let S = k.name + "";
            S = S.slice(0, i.maxNameLength), S = S.replace(/[^\w:\(\)\/? -]+/gmi, " "), S = S.replace(/[^\x00-\x7F]/g, " "), S = S.trim();
            let O = !1;
    ...
    this.update = function(k) {
        ...
        if ((s.getDistance(this.x, this.y, i.volcanoLocationX, i.volcanoLocationY) || 0) < i.volcanoAggressionRadius && (this.timeSpentNearVolcano += k, this.timeSpentNearVolcano >= 1e3 && (this.changeHealth(i.volcanoDamagePerSecond, null), p.send(this.id, "8", Math.round(this.x), Math.round(this.y), i.volcanoDamagePerSecond, -1), this.timeSpentNearVolcano %= 1e3)), this.shameTimer > 0 && (this.shameTimer -= k, this.shameTimer <= 0 && (this.shameTimer = 0, this.shameCount = 0)), v -= k, v <= 0) {
            const _ = (this.skin && this.skin.healthRegen ? this.skin.healthRegen : 0) + (this.tail && this.tail.healthRegen ? this.tail.healthRegen : 0);
            _ && this.changeHealth(_, this), this.dmgOverTime.dmg && (this.changeHealth(-this.dmgOverTime.dmg, this.dmgOverTime.doer), this.dmgOverTime.time -= 1, this.dmgOverTime.time <= 0 && (this.dmgOverTime.dmg = 0)), this.healCol && this.changeHealth(this.healCol, this), v = 1e3
        }
        if (!this.alive) return;
        if (this.slowMult < 1 && (this.slowMult += 8e-4 * k, this.slowMult > 1 && (this.slowMult = 1)), this.noMovTimer += k, (this.xVel || this.yVel) && (this.noMovTimer = 0), this.lockMove) this.xVel = 0, this.yVel = 0;
            ...
            !this.zIndex && this.y >= i.mapScale / 2 - i.riverWidth / 2 && this.y <= i.mapScale / 2 + i.riverWidth / 2 && (this.skin && this.skin.watrImm ? (_ *= .75, this.xVel += i.waterCurrent * .4 * k) : (_ *= .33, this.xVel += i.waterCurrent * k));
        ...
        if (this.xVel && (this.xVel *= Rs(i.playerDecel, k), this.xVel <= .01 && this.xVel >= -.01 && (this.xVel = 0)), this.yVel && (this.yVel *= Rs(i.playerDecel, k), this.yVel <= .01 && this.yVel >= -.01 && (this.yVel = 0)), this.x - this.scale < 0 ? this.x = this.scale : this.x + this.scale > i.mapScale && (this.x = i.mapScale - this.scale), this.y - this.scale < 0 ? this.y = this.scale : this.y + this.scale > i.mapScale && (this.y = i.mapScale - this.scale), this.buildIndex < 0) {
            if (this.reloads[this.weaponIndex] > 0) this.reloads[this.weaponIndex] -= k, this.gathering = this.mouseState;
                ...
                if (c.weapons[this.weaponIndex].gather != null) this.gather(o);
                    ...
                    c.weapons[this.weaponIndex].rec && (this.xVel -= c.weapons[this.weaponIndex].rec * at(this.dir), this.yVel -= c.weapons[this.weaponIndex].rec * lt(this.dir)), n.addProjectile(this.x + V * at(this.dir), this.y + V * lt(this.dir), this.dir, c.projectiles[F].range * z, c.projectiles[F].speed * z, F, this, null, this.zIndex)
                } else _ = !1;
        ...
        if (this.canBuild(k) && !(k.consume && this.skin && this.skin.noEat) && (k.consume || r.checkItemLocation(O, L, k.scale, .6, k.id, !1, this))) {
            ...
            } else U = !0, k.group.limit && this.changeItemCount(k.group.id, 1), k.pps && (this.pps += k.pps), r.add(r.objects.length, O, L, this.dir, k.scale, k.type, k, !1, this);
            U && (this.useRes(k), this.buildIndex = -1)
        }
        ...
        if (!i.inSandbox)
            for (let O = 0; O < k.req.length;) this.addResource(i.resourceTypes.indexOf(k.req[O]), -Math.round(k.req[O + 1] * (S || 1))), O += 2
        ...
        this.noMovTimer = 0, this.slowMult -= c.weapons[this.weaponIndex].hitSlow || .3, this.slowMult < 0 && (this.slowMult = 0);
        ...
        for (let $ = 0; $ < F.length; ++$)
            for (var _ = 0; _ < F[$].length; ++_)
                if (P = F[$][_], P.active && !P.dontGather && !L[P.sid] && P.visibleToPlayer(this) && (U = s.getDistance(this.x, this.y, P.x, P.y) - P.scale, U <= c.weapons[this.weaponIndex].range && (q = s.getDirection(P.x, P.y, this.x, this.y), s.getAngleDist(q, this.dir) <= i.gatherAngle))) {
                    if (L[P.sid] = 1, P.health) {
            ...
            if (P = o[_] || l[_ - o.length], P != this && P.alive && !(P.team && P.team == this.team) && (U = s.getDistance(this.x, this.y, P.x, P.y) - P.scale * 1.8, U <= c.weapons[this.weaponIndex].range && (q = s.getDirection(P.x, P.y, this.x, this.y), s.getAngleDist(q, this.dir) <= i.gatherAngle))) {
    ...
    this.animate = function(k) {
        this.animTime > 0 && (this.animTime -= k, this.animTime <= 0 ? (this.animTime = 0, this.dirPlus = 0, x = 0, D = 0) : D == 0 ? (x += k / (this.animSpeed * i.hitReturnRatio), this.dirPlus = s.lerp(0, this.targetAngle, Math.min(1, x)), x >= 1 && (x = 1, D = 1)) : (x -= k / (this.animSpeed * (1 - i.hitReturnRatio)), this.dirPlus = s.lerp(0, this.targetAngle, Math.max(0, x))))
        ...
        if (this.active) {
            ...
            if (this.skipMov ? this.skipMov = !1 : (this.x += p * Math.cos(this.dir), this.y += p * Math.sin(this.dir), this.range -= p, this.range <= 0 && (this.x += this.range * Math.cos(this.dir), this.y += this.range * Math.sin(this.dir), p = 1, this.range = 0, this.active = !1)), o) {
                ...
                for (let w = 0; w < m.length; ++w)
                    for (let v = 0; v < m[w].length; ++v) c = m[w][v], h = c.getScale(), c.active && this.ignoreObj != c.sid && this.layer <= c.layer && l.indexOf(c) < 0 && !c.ignoreCollision && r.lineInRect(c.x - h, c.y - h, c.x + h, c.y + h, this.x, this.y, this.x + p * Math.cos(this.dir), this.y + p * Math.sin(this.dir)) && l.push(c);
                if (l.length > 0) {
                    let w = null,
                        v = null,
                        x = null;
        ...
        t = {
            ...
            bytesToBase64: function(i) {
                for (var s = [], n = 0; n < i.length; n += 3)
                    for (var r = i[n] << 16 | i[n + 1] << 8 | i[n + 2], o = 0; o < 4; o++) n * 8 + o * 6 <= i.length * 8 ? s.push(e.charAt(r >>> 6 * (3 - o) & 63)) : s.push("=");
                return s.join("")
            },
...
function qc(e) {
    ...
    n._ff = function(r, o, l, c, a, u, p) {
        ...
        var h = r + (l ^ (o | ~c)) + (a >>> 0) + p;
        return (h << u | h >>> 32 - u) + o
    }, n._blocksize = 16, n._digestsize = 16, $r.exports = function(r, o) {
    ...
    return e.normalize = function(t) {
        ...
        if (t.length) {
            for (var s = t[0] != null && t[0].key != null, n = 1; n < t.length; n++)
                if ((t[n] != null && t[n].key != null) !== s) throw new TypeError(s && (t[n] != null || typeof t[n] == "boolean") ? "In fragments, vnodes must either all have keys or none have keys. You may wish to consider using an explicit keyed empty fragment, m.fragment({key: ...}), instead of a hole." : "In fragments, vnodes must either all have keys or none have keys.");
...
function Jc(e) {
    ...
    return s.length > 0 && (n.className = s.join(" ")), Zr[e] = {
        tag: i,
        attrs: n
    }
}
...
function Qc(e, t) {
    ...
    if (t.tag = e.tag, t.attrs = {}, !zs(e.attrs) && !zs(i)) {
        var r = {};
...
function Zc(e) {
    ...
    return typeof e == "string" && (t.children = Yc.normalizeChildren(t.children), e !== "[") ? Qc(Zr[e] || Jc(e), t) : (t.tag = e, t)
}
var jr = Zc,
    jc = Ge(),
    eh = function(e) {
        return e == null && (e = ""), jc("<", void 0, void 0, e, void 0, void 0)
    },
    th = Ge(),
    ih = Qr,
    nh = function() {
        var e = ih.apply(0, arguments);
        return e.tag = "[", e.children = th.normalizeChildren(e.children), e
    },
    ts = jr;
ts.trust = eh;
ts.fragment = nh;
    ...
    return e.prototype.then = function(t, i) {
        ...
        return new e(function(i, s) {
            ...
            if (t.length === 0) i([]);
                ...
                for (var l = 0; l < t.length; l++)(function(c) {
                    function a(u) {
                        r++, o[c] = u, r === n && i(o)
                    }
...
var _t = eo();
typeof window < "u" ? (typeof window.Promise > "u" ? window.Promise = _t : window.Promise.prototype.finally || (window.Promise.prototype.finally = _t.prototype.finally), hi.exports = window.Promise) : typeof rt < "u" ? (typeof rt.Promise > "u" ? rt.Promise = _t : rt.Promise.prototype.finally || (rt.Promise.prototype.finally = _t.prototype.finally), hi.exports = rt.Promise) : hi.exports = _t;
var to = hi.exports,
    tn, Fs;
    ...
    return tn = function(t) {
        ...
        function v(d, f, g, b, I) {
            ...
            if (f.dom = B, H != null && Bi(f, H, b), X(d, B, I), !G(f) && f.children != null) {
                var Y = f.children;
                a(B, Y, 0, Y.length, g, null, b), f.tag === "select" && H != null && Wo(f, H)
            }
        }
        ...
        function k(d, f, g, b, I, A) {
            if (!(f === g || f == null && g == null))
                ...
                var H = f[0] != null && f[0].key != null,
                    ...
                    Y = 0;
                if (!H)
                    for (; Y < f.length && f[Y] == null;) Y++;
                if (!N)
                    for (; B < g.length && g[B] == null;) B++;
                if (H !== N) te(d, f, Y, f.length), a(d, g, B, g.length, b, I, A);
                else if (N) {
                    for (var ve = f.length - 1, fe = g.length - 1, ii, xe, oe, ge, Z, Ui; ve >= Y && fe >= B && (ge = f[ve], Z = g[fe], ge.key === Z.key);) ge !== Z && S(d, ge, Z, b, I, A), Z.dom != null && (I = Z.dom), ve--, fe--;
                    for (; ve >= Y && fe >= B && (xe = f[Y], oe = g[B], xe.key === oe.key);) Y++, B++, xe !== oe && S(d, xe, oe, b, $(f, Y, I), A);
                    for (; ve >= Y && fe >= B && !(B === fe || xe.key !== Z.key || ge.key !== oe.key);) Ui = $(f, Y, I), V(d, ge, Ui), ge !== oe && S(d, ge, oe, b, Ui, A), ++B <= --fe && V(d, xe, I), xe !== Z && S(d, xe, Z, b, I, A), Z.dom != null && (I = Z.dom), Y++, ve--, ge = f[ve], Z = g[fe], xe = f[Y], oe = g[B];
                    ...
                    if (B > fe) te(d, f, Y, ve + 1);
                        ...
                        var Jo = I,
                            ...
                            Wi = 0,
                            ii, Xi;
                        for (ne = 0; ne < Ms; ne++) At[ne] = -1;
                        for (ne = fe; ne >= B; ne--) {
                            ii == null && (ii = W(f, Y, ve + 1)), Z = g[ne];
                            var st = ii[Z.key];
                            st != null && (qi = st < qi ? st : -1, At[ne - B] = st, ge = f[st], f[st] = null, ge !== Z && S(d, ge, Z, b, I, A), Z.dom != null && (I = Z.dom), Wi++)
                        }
                        if (I = Jo, Wi !== ve - Y + 1 && te(d, f, Y, ve + 1), Wi === 0) a(d, g, B, fe + 1, b, I, A);
                        else if (qi === -1)
                            for (Xi = _(At), Ni = Xi.length - 1, ne = fe; ne >= B; ne--) oe = g[ne], At[ne - B] === -1 ? u(d, oe, b, A, I) : Xi[Ni] === ne - B ? Ni-- : V(d, oe, I), oe.dom != null && (I = g[ne].dom);
                        else
                            for (ne = fe; ne >= B; ne--) oe = g[ne], At[ne - B] === -1 && u(d, oe, b, A, I), oe.dom != null && (I = g[ne].dom)
                    }
                } else {
                    var Li = f.length < g.length ? f.length : g.length;
                    for (B = B < Y ? B : Y; B < Li; B++) xe = f[B], oe = g[B], !(xe === oe || xe == null && oe == null) && (xe == null ? u(d, oe, b, A, $(f, B + 1, I)) : oe == null ? ie(d, xe) : S(d, xe, oe, b, $(f, B + 1, I), A));
                    f.length > Li && te(d, f, B, f.length), g.length > Li && a(d, g, B, g.length, b, I, A)
                }
            }
        }
        ...
        function S(d, f, g, b, I, A) {
            var H = f.tag,
                N = g.tag;
            if (H === N) {
                if (g.state = f.state, g.events = f.events, Ko(g, f)) return;
        ...
        function q(d, f, g, b) {
            var I = f.dom = d.dom;
            b = r(f) || b, f.tag === "textarea" && f.attrs == null && (f.attrs = {}), Xo(f, d.attrs, f.attrs, b), G(f) || k(I, d.children, f.children, g, null, b)
        }
        ...
        function $(d, f, g) {
            for (; f < d.length; f++)
                if (d[f] != null && d[f].dom != null) return d[f].dom;
            return g
        }
        ...
        function z(d, f, g) {
            for (; g.dom != null && g.dom.parentNode === d;) {
                if (typeof g.tag != "string") {
                    ...
                    for (var b = 0; b < g.instance.length; b++) f.appendChild(g.instance[b]);
        ...
        function nt(d) {
            if (typeof d.tag != "string" && typeof d.state.onremove == "function" && l.call(d.state.onremove, d), d.attrs && typeof d.attrs.onremove == "function" && l.call(d.attrs.onremove, d), typeof d.tag != "string") d.instance != null && nt(d.instance);
            else {
                var f = d.children;
                if (Array.isArray(f))
        ...
        function Ye(d, f, g, b) {
            if (!(f === "key" || f === "is" || g == null || bs(f)))
                if (f[0] === "o" && f[1] === "n") Is(d, f, void 0);
                else if (f === "style") Ts(d.dom, g, null);
            else if (Ss(d, f, b) && f !== "className" && f !== "title" && !(f === "value" && (d.tag === "option" || d.tag === "select" && d.dom.selectedIndex === -1 && d.dom === c())) && !(d.tag === "input" && f === "type")) d.dom[f] = null;
            else {
                var I = f.indexOf(":");
        ...
        function Xo(d, f, g, b) {
            if (f && f === g && console.warn("Don't reuse attrs object, use new object for every redraw, this will throw in next major"), g != null) {
                ...
                for (var A in g) Le(d, A, f && f[A], g[A], b, I)
            }
            var H;
            if (f != null)
                for (var A in f)(H = f[A]) != null && (g == null || g[A] == null) && Ye(d, A, H, b)
        }
...
function io() {
    return Vs || (Vs = 1, nn = rh()(typeof window < "u" ? window : null)), nn
}
var Ls = Ge(),
    oh = function(e, t, i) {
        var s = [],
        ...
        function c(a, u) {
            ...
            var p = s.indexOf(a);
            p >= 0 && (s.splice(p, 2), p <= r && (r -= 2), e(a, [])), u != null && (s.push(a, u), e(a, Ls(u), l))
        }
        return {
            mount: c,
            redraw: l
    ...
    ah = io(),
    is = oh(ah, typeof requestAnimationFrame < "u" ? requestAnimationFrame : null, typeof console < "u" ? console : null),
    sn, Us;

function no() {
    return Us || (Us = 1, sn = function(e) {
        ...
        function s(n, r) {
            if (Array.isArray(r))
                for (var o = 0; o < r.length; o++) s(n + "[" + o + "]", r[o]);
            else if (Object.prototype.toString.call(r) === "[object Object]")
                for (var o in r) s(n + "[" + o + "]", r[o]);
...
var lh = ns(),
    ...
    ch = function(e, t, i) {
                ...
                var u = new t(function(w, v) {
                    l(lh(c, a.params), a, function(x) {
                        if (typeof a.type == "function")
                            if (Array.isArray(x))
                                for (var D = 0; D < x.length; D++) x[D] = new a.type(x[D]);
                            else x = new a.type(x);
                        w(x)
                    }, v)
                });
        ...
        function o(l, c) {
            for (var a in l.headers)
                if (Ws.call(l.headers, a) && a.toLowerCase() === c) return !0;
            return !1
        }
        return {
            request: r(function(l, c, a, u) {
                ...
                for (var L in c.headers) Ws.call(c.headers, L) && v.setRequestHeader(L, c.headers[L]);
                v.onreadystatechange = function(U) {
                    if (!x && U.target.readyState === 4) try {
                        var q = U.target.status >= 200 && U.target.status < 300 || U.target.status === 304 || /^file:\/\//i.test(l),
                            P = U.target.response,
                            W;
                        if (w === "json") {
                            if (!U.target.responseType && typeof c.extract != "function") try {
                                P = JSON.parse(U.target.responseText)
                            } catch {
                                P = null
                            }
                        } else(!w || w === "text") && P == null && (P = U.target.responseText);
                        if (typeof c.extract == "function" ? (P = c.extract(U.target, c), q = !0) : typeof c.deserialize == "function" && (P = c.deserialize(P)), q) a(P);
                        else {
                            var F = function() {
                                try {
                                ...
                                var _ = new Error(W);
                                _.code = U.target.status, _.response = P, u(_)
                            };
    ...
    hh = to,
    fh = is,
    uh = ch(typeof window < "u" ? window : null, hh, fh.redraw),
    an, Xs;
    ...
    return cn = function(t) {
        ...
        return function(o) {
            for (var l = 0; l < s.length; l++)
                if (i.params[s[l]] !== o.params[s[l]]) return !1;
...
function oo() {
    ...
    return hn = function(i, s) {
        var n = {};
        if (s != null)
            for (var r in i) e.call(i, r) && !t.test(r) && s.indexOf(r) < 0 && (n[r] = i[r]);
        else
            for (var r in i) e.call(i, r) && !t.test(r) && (n[r] = i[r]);
        return n
    }, hn
}
var fn, Ks;
                        ...
                        var ke = D[K].component,
                            ...
                            Le = q = function(Ye) {
                                if (Le === q) {
                                    ...
                                    O = Ye != null && (typeof Ye.view == "function" || typeof Ye == "function") ? Ye : "div", L = G.params, U = X, q = null, S = ke.render ? ke : null, x === 2 ? p.redraw() : (x = 2, p.redraw.sync())
                                }
                            };
                        ke.view || typeof ke == "function" ? (ke = {}, Le(Bi)) : ke.onmatch ? m.then(function() {
        ...
        return V.set = function(z, X, G) {
            ...
            view: function(z) {
                var X = t(z.attrs.selector || "a", l(z.attrs, ["options", "params", "selector", "onclick"]), z.children),
                    G, te, ie;
                return (X.attrs.disabled = !!X.attrs.disabled) ? (X.attrs.href = null, X.attrs["aria-disabled"] = "true") : (G = z.attrs.options, te = z.attrs.onclick, ie = s(X.attrs.href, z.attrs.params), X.attrs.href = V.prefix + ie, X.attrs.onclick = function(K) {
                    var ke;
...
function mh() {
    ...
    Js = 1;
    var e = is;
    return un = ph()(typeof window < "u" ? window : null, e), un
}
var Ai = sh,
    ao = uh,
    lo = is,
...
we.prototype.connect = function(e, t, i) {
    ...
    window.history.replaceState(document.title, document.title, this.generateHref(e, t, this.password)), this.server = s, this.gameIndex = i, this.log("Calling callback with address", this.serverAddress(s), "on port", this.serverPort(s)), this.callback(this.serverAddress(s), this.serverPort(s), i), Ut && clearInterval(Ut)
};
...
we.prototype.processServers = function(e) {
    return Ut && clearInterval(Ut), new Promise(t => {
        const i = {},
            s = c => {
                const a = i[c],
                    u = a[0];
        ...
        }).then(n).catch(c => {}).finally(t), Ut = setInterval(n, 5e3)
    })
};
...
const fi = (e, t) => {
    ...
    xh = (e, t, i) => {
        ...
        return i = Rn(i), s.x = e.x - t * Math.cos(i), s.y = e.y - t * Math.sin(i), s
    },
    Rn = e => e * (Math.PI / 180),
    bh = e => e * (180 / Math.PI),
    ...
    dn = new Map,
    Qs = e => {
        dn.has(e) && clearTimeout(dn.get(e)), dn.set(e, setTimeout(e, 100))
    },
    yi = (e, t, i) => {
        const s = t.split(/[ ,]+/g);
        let n;
    ...
    co = e => (e.preventDefault(), e.type.match(/^touch/) ? e.changedTouches : e),
    js = () => {
    ...
    _n = (e, t) => {
        if (e.length)
            for (let i = 0, s = e.length; i < s; i += 1) t(e[i]);
        else t(e)
    },
    Mh = (e, t, i) => ({
...
var Eh = "ontouchstart" in window,
    Ph = !!window.PointerEvent,
    Ch = !!window.MSPointerEvent,
    Bt = {
        touch: {
            start: "touchstart",
            move: "touchmove",
    ...
    vt, $t = {};
Ph ? vt = Bt.pointer : Ch ? vt = Bt.MSPointer : Eh ? (vt = Bt.touch, $t = Bt.mouse) : vt = Bt.mouse;
...
Ve.prototype.config = function(e) {
    var t = this;
    t.options = t.defaults || {}, e && (t.options = Ih(t.options, e))
};
Ve.prototype.bindEvt = function(e, t) {
    ...
    }, yi(e, vt[t], i._domHandlers_[t]), $t[t] && yi(e, $t[t], i._domHandlers_[t]), i
};
Ve.prototype.unbindEvt = function(e, t) {
    var i = this;
    return i._domHandlers_ = i._domHandlers_ || {}, Zs(e, vt[t], i._domHandlers_[t]), $t[t] && Zs(e, $t[t], i._domHandlers_[t]), delete i._domHandlers_[t], this
};
...
he.prototype.stylize = function() {
    ...
    }, pn(s.el, i), this.options.shape === "circle" && pn(s.back, t), pn(s.front, t), this.applyStyles(s), this
};
...
he.prototype.restCallback = function() {
    var e = this,
        t = {};
    t.front = rs("transition", "none", ""), e.applyStyles(t), e.trigger("rested", e.instance)
};
...
ae.prototype.createNipple = function(e, t) {
    ...
    return r.dataOnly || (er(a.ui.el, n), er(a.ui.front, a.frontPosition)), i.nipples.push(a), i.trigger("added " + a.identifier + ":added", a), i.manager.trigger("added " + a.identifier + ":added", a), i.bindNipple(a), a
};
...
ae.prototype.onstart = function(e) {
    ...
    return _n(e, n), t.manager.bindDocument(), !1
};
ae.prototype.processOnStart = function(e) {
    var t = this,
        i = t.options,
        s, n = t.manager.getIdentifier(e),
...
ae.prototype.processOnMove = function(e) {
    ...
    var a = fi(c, n.position),
        ...
        w, v;
    if (n.options.shape === "circle" ? (w = Math.min(a, l), v = xh(n.position, w, u)) : (v = Mh(c, n.position, l), w = fi(v, n.position)), i.follow) {
        if (a > l) {
            let S = c.x - v.x,
                O = c.y - v.y;
...
function de(e) {
    var t = this;
    t.ids = {}, t.index = 0, t.collections = [], t.scroll = js(), t.config(e), t.prepareCollections();
    var i = function() {
        var n;
...
de.prototype.onAny = function(e, t) {
    var i = this,
        s, n = "processOn" + e.charAt(0).toUpperCase() + e.slice(1);
    t = co(t);
    var r = function(l, c, a) {
            a.ids.indexOf(c) >= 0 && (a[n](l), l._found_ = !0)
        },
        o = function(l) {
            s = i.getIdentifier(l), _n(i.collections, r.bind(null, l, s)), l._found_ || i.removeIdentifier(s)
        };
    return _n(t, o), !1
};
...
const wi = location.hostname === "localhost" || location.hostname === "127.0.0.1",
    _h = !1,
    os = wi || _h;
fo ? (ui = "https://api-sandbox.moomoo.io", di = "moomoo.io") : Rh ? (ui = "https://api-dev.moomoo.io", di = "moomoo.io") : (ui = "https://api.moomoo.io", di = "moomoo.io");
const Bh = !os,
...
function mn(e) {
    qe.start(xi, function(t, i, s) {
        ...
        e && (r += "?token=" + encodeURIComponent(e)), wi && (r = wsprotocol+"://"+window.location.host+"/server"), ee.connect(r, function(o) {
            if (Hn) {
                Hn = !1;
                return
            }
...
function Lh() {
    vi || (vi = !0, Di("moofoll", 1))
}
let mo, $e, mt = 1,
    be, It, gn, sr = Date.now();
var He;
let Ee;
const ye = [],
    J = [];
...
function ds(e, t) {
    Oi.style.display = "block", hs.style.display = "none", Qt.style.display = "none", Wt.style.display = "none", Et.style.display = "block", Et.innerHTML = e + (t ? "<a href='javascript:window.location.href=window.location.href' class='ytLink'>reload</a>" : "")
}

function Kh() {
    Jt.hidden = !0, Et.style.display = "none", Oi.style.display = "block", Qt.style.display = "block", yf(), Jh(), Bf(), Et.style.display = "none", Qt.style.display = "block";
    let e = Nt("moo_name") || "";
    !e.length && FRVR.profile && (e = FRVR.profile.name(), e && (e += Math.floor(Math.random() * 90) + 9)), Zt.value = e || ""
}

function Jh() {
    Fn.onclick = C.checkTrusted(function() {
        ds("Connecting..."), as() ? vs() : Hh()
    }), C.hookTouchEvents(Fn), wn && (wn.onclick = C.checkTrusted(function() {
        qo("https://krunker.io/?play=SquidGame_KB")
    }), C.hookTouchEvents(wn)), kn && (kn.onclick = C.checkTrusted(function() {
        setTimeout(function() {
            Fh()
        }, 10)
    }), C.hookTouchEvents(kn)), Vn.onclick = C.checkTrusted(function() {
        kf()
    }), C.hookTouchEvents(Vn), lr.onclick = C.checkTrusted(function() {
        lf()
    }), C.hookTouchEvents(lr), cr.onclick = C.checkTrusted(function() {
        mf()
    }), C.hookTouchEvents(cr), hr.onclick = C.checkTrusted(function() {
        Po()
    }), C.hookTouchEvents(hr), me.onclick = C.checkTrusted(function() {
        Oo()
    ...
    view: () => {
        ...
        const t = Object.keys(qe.servers).map(i => {
            ...
            const r = qe.servers[i].map(o => {
                ...
                return u && (xi = i + ":" + a, p.selected = !0), Ne("option", p, c)
            });
...
Ne.mount(Uh, Qh);
var Un, Nn;
location.hostname == "sandbox.moomoo.io" ? (Un = "Back to MooMoo", Nn = "//moomoo.io/") : (Un = "Try the sandbox", Nn = "//sandbox.moomoo.io/");
...
const ef = e => {
    if (window.blockRedraw = !1, FRVR.channelCharacteristics.allowNavigation) {
        const [t, i] = e.target.value.split(":");
        qe.switchServer(t, i)
    } else ki && (ki = !1, zn = !1, Hn = !0, Mi = !0, ee.close())
};
...
function Se(e, t, i) {
    if (E && e) {
        if (C.removeAllChildren(Ue), Ue.classList.add("visible"), C.generateElement({
                id: "itemInfoName",
    ...
    } else Ue.classList.remove("visible")
}
let Pt = [],
    wt = [];
...
function sf(e) {
    Oe.push(e), Te.style.display == "block" && ei()
}

function rf(e, t) {
    E && (E.team = e, E.isOwner = t, Te.style.display == "block" && ei())
}

function of(e) {
    wt = e, Te.style.display == "block" && ei()
}
...
function lf() {
    ks(), Te.style.display != "block" ? ei() : qn()
}
...
function ei() {
    if (E && E.alive) {
        if (Ri(), We.style.display = "none", Te.style.display = "block", C.removeAllChildren(ri), E.team)
            for (var e = 0; e < wt.length; e += 2)(function(t) {
            ...
            for (var e = 0; e < Oe.length; ++e)(function(i) {
        ...
        else C.generateElement({
            class: "allianceItem",
            text: "No Tribes Yet",
            parent: ri
        });
        C.removeAllChildren(oi), E.team ? C.generateElement({
            ...
            onkeypress: t => {
                if (t.key === "Enter") return t.preventDefault(), Xn(), !1
            },
            parent: oi
        }), C.generateElement({
            tag: "div",
...
function Wn(e) {
    ee.send("P", Pt[0].sid, e), Pt.splice(0, 1), ps()
}
...
function cf() {
    this.init = function(e, t) {
        ...
        this.active && (this.scale += .05 * t, this.scale >= T.mapPingScale ? this.active = !1 : (e.globalAlpha = 1 - Math.max(0, this.scale / T.mapPingScale), e.beginPath(), e.arc(this.x / T.mapScale * me.width, this.y / T.mapScale * me.width, this.scale, 0, 2 * Math.PI), e.stroke()))
    }
}
...
function hf(e, t) {
    for (let i = 0; i < bt.length; ++i)
        if (!bt[i].active) {
            Je = bt[i];
            break
        } Je || (Je = new cf, bt.push(Je)), Je.init(e, t)
}
...
function df(e) {
    if (E && E.alive) {
        ...
        pi && (ce.fillStyle = "#fc5553", ce.font = "34px Hammersmith One", ce.textBaseline = "middle", ce.textAlign = "center", ce.fillText("x", pi.x / T.mapScale * me.width, pi.y / T.mapScale * me.height)), je && (ce.fillStyle = "#fff", ce.font = "34px Hammersmith One", ce.textBaseline = "middle", ce.textAlign = "center", ce.fillText("x", je.x / T.mapScale * me.width, je.y / T.mapScale * me.height))
    }
}
let Gn = 0;
...
function mf() {
    We.style.display != "block" ? (We.style.display = "block", Te.style.display = "none", Ri(), ms()) : Yn()
}
...
function gf(e, t, i) {
    i ? e ? E.tailIndex = t : E.tails[t] = 1 : e ? E.skinIndex = t : E.skins[t] = 1, We.style.display == "block" && ms()
}
...
function yf() {
    ...
    bn(e ? e == "true" : typeof cordova < "u"), $e = Nt("show_ping") == "true", Jt.hidden = !$e || !Kt, Nt("moo_moosic"), setInterval(function() {
    ...
    for (var t = 0; t < R.list.length + R.weapons.length; ++t)(function(s) {
        ...
        if (r.translate(n.width / 2, n.height / 2), r.imageSmoothingEnabled = !1, r.webkitImageSmoothingEnabled = !1, r.mozImageSmoothingEnabled = !1, R.weapons[s]) {
            ...
            var o = new Image;
            Qn[R.weapons[s].src] = o, o.onload = function() {
                this.isLoaded = !0;
    ...
    Zt.onchange = i => {
        ...
        if (i.key === "Enter") return i.preventDefault(), Fn.onclick(i), !1
    }, Ln.checked = mo, Ln.onchange = C.checkTrusted(function(i) {
        bn(i.target.checked)
    }), vn.checked = $e, vn.onchange = C.checkTrusted(function(i) {
        $e = vn.checked, Jt.hidden = !$e, Di("show_ping", $e ? "true" : "false")
    })
}
...
function bn(e) {
    mo = e, mt = e && window.devicePixelRatio || 1, Ln.checked = e, Di("native_resolution", e.toString()), gs()
}
...
function kf() {
    qt.classList.contains("showing") ? (qt.classList.remove("showing"), ar.innerText = "Settings") : (qt.classList.add("showing"), ar.innerText = "Close")
}

function Eo() {
    let e = "";
    for (let t = 0; t < T.skinColors.length; ++t) t == cs ? e += "<div class='skinColorItem activeSkin' style='background-color:" + T.skinColors[t] + "' onclick='selectSkinColor(" + t + ")'></div>" : e += "<div class='skinColorItem' style='background-color:" + T.skinColors[t] + "' onclick='selectSkinColor(" + t + ")'></div>";
    Yh.innerHTML = e
}
...
function Po() {
    ti ? setTimeout(function() {
        ...
        e && wr(e)
    }, 1) : bi.style.display == "block" ? (Ft.value && wr(Ft.value), Ri()) : (We.style.display = "none", Te.style.display = "none", bi.style.display = "block", Ft.focus(), ks()), Ft.value = ""
}
...
function Ri() {
    Ft.value = "", bi.style.display = "none"
}
...
if (!uo) {
    let t = function(n) {
            n.preventDefault(), n.stopPropagation(), tt(!1), wo = n.clientX, ko = n.clientY
        },
        i = function(n) {
            tt(!1), Ee != 1 && (Ee = 1, it())
        },
...
function ws() {
    return E ? (!E.lockDir && !ti && (Si = Math.atan2(ko - yt / 2, wo - gt / 2)), C.fixTo(Si || 0, 2)) : 0
}
var He = {},
    Ti = {
        87: [0, -1],
...
function Tf(e) {
    ...
    t == 27 ? Io() : E && E.alive && Do() && (He[t] || (He[t] = 1, t == 69 ? Ef() : t == 67 ? ff() : t == 88 ? Mf() : E.weapons[t - 49] != null ? Yt(E.weapons[t - 49], !0) : E.items[t - 49 - E.weapons.length] != null ? Yt(E.items[t - 49 - E.weapons.length]) : t == 81 ? Yt(E.items[0]) : t == 82 ? Oo() : Ti[t] ? Ii() : t == 32 && (Ee = 1, it())))
}
...
function If(e) {
    if (E && E.alive) {
        ...
        if (t == 13) {
            ...
            Po()
        } else Do() && He[t] && (He[t] = 0, Ti[t] ? Ii() : t == 32 && (Ee = 0, it()))
    }
}
...
function Ii() {
    const e = Sf();
    (Sn == null || e == null || Math.abs(e - Sn) > .3) && (ee.send("a", e), Sn = e)
}
...
function vs() {
    Jt.hidden = !$e, window.onbeforeunload = function(e) {
        return "Are you sure?"
    }, window.FRVR && window.FRVR.tracker.levelStart("game_start"), Di("moo_name", Zt.value), !Kt && as() && (Kt = !0, Vh.stop("menu"), ds("Loading..."), ee.send("M", {
        name: Zt.value,
        moofoll: vi,
        skin: cs
    })), Pf()
...
function Af(e) {
    Et.style.display = "none", Qt.style.display = "block", Oi.style.display = "none", He = {}, yo = e, Ee = 0, Kt = !0, Mi && (Mi = !1, et.length = 0), uo && Dh.enable({
        onStartMoving: () => {
            Yn(), qn(), tt(!0), Kn = !0
        },
        onStopMoving: () => {
        ...
        onRotateMoving: (t, i) => {
            i.force < .25 || (Ao = -i.angle.radian, Ii(), Tn || (Si = -i.angle.radian))
        },
        onStartAttacking: () => {
            Yn(), qn(), tt(!0), Tn = !0, E.buildIndex < 0 && (Ee = 1, it())
        },
        onStopAttacking: () => {
            E.buildIndex >= 0 && (Ee = 1, it()), Ee = 0, it(), Tn = !1
        },
...
function Df(e, t, i, s) {
    s === -1 ? Bn.showText(e, t, 50, .18, 500, i, "#ee5551") : Bn.showText(e, t, 50, .18, 500, Math.abs(i), i >= 0 ? "#fff" : "#8ecc51")
}
let mi = 99999;
...
function Of() {
    ...
    hs.style.display = "none", Io(), pi = {
        x: E.x,
        y: E.y
    }, Et.style.display = "none", Wt.style.display = "block", Wt.style.fontSize = "0px", mi = 0, setTimeout(function() {
        Qt.style.display = "block", Oi.style.display = "block", Wt.style.display = "none"
    }, T.deathFadeout), vo()
}
...
function Ro() {
    Nh.innerText = E.points, qh.innerText = E.food, Wh.innerText = E.wood, Xh.innerText = E.stone, Gh.innerText = E.kills
}
const Vt = {},
    In = ["crown", "skull"];
...
function Bf() {
    for (let e = 0; e < In.length; ++e) {
        ...
        t.onload = function() {
            this.isLoaded = !0
        }, t.src = "./img/icons/" + In[e] + ".png", Vt[In[e]] = t
    }
}
const ut = [];
...
function _o(e, t) {
    if (E.upgradePoints = e, E.upgrAge = t, e > 0) {
        ...
        ut.length ? (ht.style.display = "block", si.style.display = "block", si.innerHTML = "SELECT ITEMS (" + e + ")") : (ht.style.display = "none", si.style.display = "none", Se())
    } else ht.style.display = "none", si.style.display = "none", Se()
}

function Bo(e, t, i) {
    e != null && (E.XP = e), t != null && (E.maxXP = t), i != null && (E.age = i), i == T.maxAge ? (pr.innerHTML = "MAX AGE", mr.style.width = "100%") : (pr.innerHTML = "AGE " + E.age, mr.style.width = E.XP / E.maxXP * 100 + "%")
}
...
function Hf() {
    {
        if (E && (!gn || It - gn >= 1e3 / T.clientSendRate)) {
            gn = It;
            const a = ws();
            kr !== a && (kr = a, ee.send("D", a))
        }
        if (mi < 120 && (mi += .1 * be, Wt.style.fontSize = Math.min(Math.round(mi), 120) + "px"), E) {
            const a = C.getDistance(Re, _e, E.x, E.y),
                u = C.getDirection(E.x, E.y, Re, _e),
                p = Math.min(a * .01 * be, a);
            a > .05 ? (Re += p * Math.cos(u), _e += p * Math.sin(u)) : (Re = E.x, _e = E.y)
        ...
        for (var e, t = 0; t < J.length + ye.length; ++t)
            ...
            c = _e - re / 2;
        T.snowBiomeTop - c <= 0 && T.mapScale - T.snowBiomeTop - c >= re ? (M.fillStyle = "#b6db66", M.fillRect(0, 0, se, re)) : T.mapScale - T.snowBiomeTop - c <= 0 ? (M.fillStyle = "#dbc666", M.fillRect(0, 0, se, re)) : T.snowBiomeTop - c >= re ? (M.fillStyle = "#fff", M.fillRect(0, 0, se, re)) : T.snowBiomeTop - c >= 0 ? (M.fillStyle = "#fff", M.fillRect(0, 0, se, T.snowBiomeTop - c), M.fillStyle = "#b6db66", M.fillRect(0, T.snowBiomeTop - c, se, re - (T.snowBiomeTop - c))) : (M.fillStyle = "#b6db66", M.fillRect(0, 0, se, T.mapScale - T.snowBiomeTop - c), M.fillStyle = "#dbc666", M.fillRect(0, T.mapScale - T.snowBiomeTop - c, se, re - (T.mapScale - T.snowBiomeTop - c))), Mi || (ct += yn * T.waveSpeed * be, ct >= T.waveMax ? (ct = T.waveMax, yn = -1) : ct <= 1 && (ct = yn = 1), M.globalAlpha = 1, M.fillStyle = "#dbc666", br(l, c, M, T.riverPadding), M.fillStyle = "#91b2db", br(l, c, M, (ct - 1) * 250)), M.lineWidth = 4, M.strokeStyle = "#000", M.globalAlpha = .06, M.beginPath();
        for (var i = -Re; i < se; i += re / 18) i > 0 && (M.moveTo(i, 0), M.lineTo(i, re));
        for (let a = -_e; a < re; a += re / 18) i > 0 && (M.moveTo(0, a), M.lineTo(se, a));
        M.stroke(), M.globalAlpha = 1, M.strokeStyle = jt, zt(-1, l, c), M.globalAlpha = 1, M.lineWidth = Xe, vr(0, l, c), Sr(l, c, 0), M.globalAlpha = 1;
        for (var t = 0; t < ye.length; ++t) y = ye[t], y.active && y.visible && (y.animate(be), M.save(), M.translate(y.x - l, y.y - c), M.rotate(y.dir + y.dirPlus - Math.PI / 2), tu(y, M), M.restore());
        if (zt(0, l, c), vr(1, l, c), zt(1, l, c), Sr(l, c, 1), zt(2, l, c), zt(3, l, c), M.fillStyle = "#000", M.globalAlpha = .09, l <= 0 && M.fillRect(0, 0, -l, re), T.mapScale - l <= se) {
            var s = Math.max(0, -c);
        ...
        M.globalAlpha = 1, M.fillStyle = "rgba(0, 0, 70, 0.35)", M.fillRect(0, 0, se, re), M.strokeStyle = yr;
        for (var t = 0; t < J.length + ye.length; ++t)
            if (y = J[t] || ye[t - J.length], y.visible && (y.skinIndex != 10 || y == E || y.team && y.team == E.team)) {
                ...
                if (u != "") {
                    if (M.font = (y.nameScale || 30) + "px Hammersmith One", M.fillStyle = "#fff", M.textBaseline = "middle", M.textAlign = "center", M.lineWidth = y.nameScale ? 11 : 8, M.lineJoin = "round", M.strokeText(u, y.x - l, y.y - c - y.scale - T.nameY), M.fillText(u, y.x - l, y.y - c - y.scale - T.nameY), y.isLeader && Vt.crown.isLoaded) {
                ...
                y.health > 0 && (T.healthBarWidth, M.fillStyle = yr, M.roundRect(y.x - l - T.healthBarWidth - T.healthBarPad, y.y - c + y.scale + T.nameY, T.healthBarWidth * 2 + T.healthBarPad * 2, 17, 8), M.fill(), M.fillStyle = y == E || y.team && y.team == E.team ? "#8ecc51" : "#cc5151", M.roundRect(y.x - l - T.healthBarWidth, y.y - c + y.scale + T.nameY + T.healthBarPad, T.healthBarWidth * 2 * (y.health / y.maxHealth), 17 - T.healthBarPad * 2, 7), M.fill())
            } Bn.update(be, M, l, c);
...
function vr(e, t, i) {
    for (let s = 0; s < Mt.length; ++s) y = Mt[s], y.active && y.layer == e && (y.update(be), y.active && Ho(y.x - t, y.y - i, y.scale) && (M.save(), M.translate(y.x - t, y.y - i), M.rotate(y.dir), Jn(0, 0, y, M), M.restore()))
}
const xr = {};
...
function Jn(e, t, i, s, n) {
    if (i.src) {
        ...
        o || (o = new Image, o.onload = function() {
            this.isLoaded = !0
        }, o.src = "./img/weapons/" + r + ".png", xr[r] = o), o.isLoaded && s.drawImage(o, e - i.scale / 2, t - i.scale / 2, i.scale, i.scale)
...
function zt(e, t, i) {
    let s, n, r;
    for (let o = 0; o < et.length; ++o) y = et[o], y.active && (n = y.x + y.xWiggle - t, r = y.y + y.yWiggle - i, e == 0 && y.update(be), y.layer == e && Ho(n, r, y.scale + (y.blocker || 0)) && (M.globalAlpha = y.hideFromEnemy ? .6 : 1, y.isItem ? (s = xs(y), M.save(), M.translate(n, r), M.rotate(y.dir), M.drawImage(s, -(s.width / 2), -(s.height / 2)), y.blocker && (M.strokeStyle = "#db6e6e", M.globalAlpha = .3, M.lineWidth = 6, Q(0, 0, y.blocker, M, !1, !0)), M.restore()) : y.type === 4 ? Ff() : (s = Nf(y), M.drawImage(s, n - s.width / 2, r - s.height / 2))))
}
...
function Sr(e, t, i) {
    M.globalAlpha = 1;
    for (let s = 0; s < J.length; ++s) y = J[s], y.zIndex == i && (y.animate(be), y.visible && (y.skinRot += .002 * be, or = (y == E ? ws() : y.dir) + y.dirPlus, M.save(), M.translate(y.x - e, y.y - t), M.rotate(or), Lf(y, M), M.restore()))
}
...
function Lf(e, t) {
    ...
    if (e.tailIndex > 0 && Uf(e.tailIndex, t, e), e.buildIndex < 0 && !R.weapons[e.weaponIndex].aboveHand && (Pr(R.weapons[e.weaponIndex], T.weaponVariants[e.weaponVariant].src, e.scale, 0, t), R.weapons[e.weaponIndex].projectile != null && !R.weapons[e.weaponIndex].hideProjectile && Jn(e.scale, 0, R.projectiles[R.weapons[e.weaponIndex].projectile], M)), t.fillStyle = T.skinColors[e.skinColor], Q(e.scale * Math.cos(i), e.scale * Math.sin(i), 14), Q(e.scale * n * Math.cos(-i * s), e.scale * n * Math.sin(-i * s), 14), e.buildIndex < 0 && R.weapons[e.weaponIndex].aboveHand && (Pr(R.weapons[e.weaponIndex], T.weaponVariants[e.weaponVariant].src, e.scale, 0, t), R.weapons[e.weaponIndex].projectile != null && !R.weapons[e.weaponIndex].hideProjectile && Jn(e.scale, 0, R.projectiles[R.weapons[e.weaponIndex].projectile], M)), e.buildIndex >= 0) {
        const r = xs(R.list[e.buildIndex]);
        t.drawImage(r, e.scale - R.list[e.buildIndex].holdOffset, -r.width / 2)
    }
    Q(0, 0, e.scale, t), e.skinIndex > 0 && (t.rotate(Math.PI / 2), zo(e.skinIndex, t, null, e))
}
const Tr = {},
    Ir = {};
let De;
...
function zo(e, t, i, s) {
    window.console.log(e,t,i,s);
    if (De = Tr[e], !De) {
        const r = new Image;
        r.onload = function() {
            this.isLoaded = !0, this.onload = null
        }, r.src = "./img/hats/hat_" + e + ".png", Tr[e] = r, De = r
    }
    let n = i || Ir[e];
    if (!n) {
    ...
    De.isLoaded && t.drawImage(De, -n.scale / 2, -n.scale / 2, n.scale, n.scale), !i && n.topSprite && (t.save(), t.rotate(s.skinRot), zo(e + "_top", t, n, s), t.restore())
}
const Mr = {},
    Er = {};
...
function Uf(e, t, i) {
    if (De = Mr[e], !De) {
        ...
        n.onload = function() {
            this.isLoaded = !0, this.onload = null
        }, n.src = "./img/accessories/access_" + e + ".png", Mr[e] = n, De = n
    }
    let s = Er[e];
    if (!s) {
...
function Pr(e, t, i, s, n) {
    ...
    o || (o = new Image, o.onload = function() {
        this.isLoaded = !0
    }, o.src = "./img/weapons/" + r + ".png", Qn[r] = o), o.isLoaded && n.drawImage(o, i + e.xOff - e.length / 2, s + e.yOff - e.width / 2, e.length, e.width)
}
const Cr = {};
...
function Nf(e) {
    ...
    if (!s) {
        ...
        if (o.translate(r.width / 2, r.height / 2), o.rotate(C.randFloat(0, Math.PI)), o.strokeStyle = jt, o.lineWidth = Xe, e.type == 0) {
            let l;
            for (var n = 0; n < 2; ++n) l = y.scale * (n ? .5 : 1), Ie(o, y.sid % 2 === 0 ? 5 : 7, l, l * .7), o.fillStyle = t ? n ? "#fff" : "#e3f1f4" : n ? "#b4db62" : "#9ebf57", o.fill(), n || o.stroke()
        } else if (e.type == 1)
            if (t == 2) o.fillStyle = "#606060", Ie(o, 6, e.scale * .3, e.scale * .71), o.fill(), o.stroke(), o.fillStyle = "#89a54c", Q(0, 0, e.scale * .55, o), o.fillStyle = "#a5c65b", Q(0, 0, e.scale * .3, o, !0);
            else {
                Xf(o, 6, y.scale, y.scale * .7), o.fillStyle = t ? "#e3f1f4" : "#89a54c", o.fill(), o.stroke(), o.fillStyle = t ? "#6a64af" : "#c15555";
                let l;
                const c = 4,
                    a = Ze / c;
                for (var n = 0; n < c; ++n) l = C.randInt(y.scale / 3.5, y.scale / 2.3), Q(l * Math.cos(a * n), l * Math.sin(a * n), C.randInt(10, 12), o)
            }
        else(e.type == 2 || e.type == 3) && (o.fillStyle = e.type == 2 ? t == 2 ? "#938d77" : "#939393" : "#e0c655", Ie(o, 3, e.scale, e.scale), o.fill(), o.stroke(), o.fillStyle = e.type == 2 ? t == 2 ? "#b2ab90" : "#bcbcbc" : "#ebdca3", Ie(o, 3, e.scale * .55, e.scale * .65), o.fill());
        s = r, Cr[i] = s
    }
    return s
}
...
function qf() {
    ...
    s.strokeStyle = "#3e3e3e", s.lineWidth = Xe * 2, s.fillStyle = "#7f7f7f", Ar(s, 10, t), s.fill(), s.stroke(), Me.land = i;
    const n = document.createElement("canvas"),
        r = T.innerVolcanoScale * 2;
    n.width = r, n.height = r;
    const o = n.getContext("2d");
    o.strokeStyle = jt, o.lineWidth = Xe * 1.6, o.fillStyle = "#f54e16", o.strokeStyle = "#f56f16", Ar(o, 10, r), o.fill(), o.stroke(), Me.lava = n
}
qf();
const Dr = [];
...
function xs(e, t) {
    ...
    if (!i || t) {
        ...
        if (a.translate(c.width / 2, c.height / 2), a.rotate(t ? 0 : Math.PI / 2), a.strokeStyle = jt, a.lineWidth = Xe * (t ? c.width / 81 : 1), e.name == "apple") {
            ...
            Ie(a, u, e.scale * 1.1, e.scale * 1.1), a.fill(), a.stroke(), a.fillStyle = e.name == "castle wall" ? "#9da4aa" : e.name == "wood wall" ? "#c9b758" : "#bcbcbc", Ie(a, u, e.scale * .65, e.scale * .65), a.fill()
        ...
        } else if (e.name == "windmill" || e.name == "faster windmill" || e.name == "power mill") a.fillStyle = "#a5974c", Q(0, 0, e.scale, a), a.fillStyle = "#c9b758", Mn(0, 0, e.scale * 1.5, 29, 4, a), a.fillStyle = "#a5974c", Q(0, 0, e.scale * .5, a);
        else if (e.name == "mine") a.fillStyle = "#939393", Ie(a, 3, e.scale, e.scale), a.fill(), a.stroke(), a.fillStyle = "#bcbcbc", Ie(a, 3, e.scale * .55, e.scale * .65), a.fill();
        else if (e.name == "sapling")
            for (var o = 0; o < 2; ++o) {
                var l = e.scale * (o ? .5 : 1);
                Ie(a, 7, l, l * .7), a.fillStyle = o ? "#b4db62" : "#9ebf57", a.fill(), o || a.stroke()
            } else if (e.name == "pit trap") a.fillStyle = "#a5974c", Ie(a, 3, e.scale * 1.1, e.scale * 1.1), a.fill(), a.stroke(), a.fillStyle = jt, Ie(a, 3, e.scale * .65, e.scale * .65), a.fill();
            else if (e.name == "boost pad") a.fillStyle = "#7e7f82", kt(0, 0, e.scale * 2, e.scale * 2, a), a.fill(), a.stroke(), a.fillStyle = "#dbd97d", Gf(e.scale * 1, a);
        else if (e.name == "turret") {
            a.fillStyle = "#a5974c", Q(0, 0, e.scale, a), a.fill(), a.stroke(), a.fillStyle = "#939393";
            const u = 50;
            kt(0, -u / 2, e.scale * .9, u, a), Q(0, 0, e.scale * .6, a), a.fill(), a.stroke()
        ...
        } else e.name == "healing pad" ? (a.fillStyle = "#7e7f82", kt(0, 0, e.scale * 2, e.scale * 2, a), a.fill(), a.stroke(), a.fillStyle = "#db6e6e", Mn(0, 0, e.scale * .65, 20, 4, a, !0)) : e.name == "spawn pad" ? (a.fillStyle = "#7e7f82", kt(0, 0, e.scale * 2, e.scale * 2, a), a.fill(), a.stroke(), a.fillStyle = "#71aad6", Q(0, 0, e.scale * .6, a)) : e.name == "blocker" ? (a.fillStyle = "#7e7f82", Q(0, 0, e.scale, a), a.fill(), a.stroke(), a.rotate(Math.PI / 4), a.fillStyle = "#db6e6e", Mn(0, 0, e.scale * .65, 20, 4, a, !0)) : e.name == "teleporter" && (a.fillStyle = "#7e7f82", Q(0, 0, e.scale, a), a.fill(), a.stroke(), a.rotate(Math.PI / 4), a.fillStyle = "#d76edb", Q(0, 0, e.scale * .5, a, !0));
        i = c, t || (Dr[e.id] = i)
    }
    return i
}
...
function Wf(e, t, i, s, n) {
    const r = e + i * Math.cos(s),
        o = t + i * Math.sin(s),
        l = i * .4;
    n.moveTo(e, t), n.beginPath(), n.quadraticCurveTo((e + r) / 2 + l * Math.cos(s + Math.PI / 2), (t + o) / 2 + l * Math.sin(s + Math.PI / 2), r, o), n.quadraticCurveTo((e + r) / 2 - l * Math.cos(s + Math.PI / 2), (t + o) / 2 - l * Math.sin(s + Math.PI / 2), e, t), n.closePath(), n.fill(), n.stroke()
}
...
function Xf(e, t, i, s) {
    ...
    for (let l = 0; l < t; l++) o = C.randInt(i + .9, i * 1.2), e.quadraticCurveTo(Math.cos(n + r) * o, Math.sin(n + r) * o, Math.cos(n + r * 2) * s, Math.sin(n + r * 2) * s), n += r * 2;
...
function Yf() {
    ...
    ue.add(0, e, e + 200, 0, T.treeScales[3], 0), ue.add(1, e, e - 480, 0, T.treeScales[3], 0), ue.add(2, e + 300, e + 450, 0, T.treeScales[3], 0), ue.add(3, e - 950, e - 130, 0, T.treeScales[2], 0), ue.add(4, e - 750, e - 400, 0, T.treeScales[3], 0), ue.add(5, e - 700, e + 400, 0, T.treeScales[2], 0), ue.add(6, e + 800, e - 200, 0, T.treeScales[3], 0), ue.add(7, e - 260, e + 340, 0, T.bushScales[3], 1), ue.add(8, e + 760, e + 310, 0, T.bushScales[3], 1), ue.add(9, e - 800, e + 100, 0, T.bushScales[3], 1), ue.add(10, e - 800, e + 300, 0, R.list[4].scale, R.list[4].id, R.list[10]), ue.add(11, e + 650, e - 390, 0, R.list[4].scale, R.list[4].id, R.list[10]), ue.add(12, e - 400, e - 450, 0, T.rockScales[2], 2)
}

function $f(e) {
    for (let t = 0; t < e.length;) ue.add(e[t], e[t + 1], e[t + 2], e[t + 3], e[t + 4], e[t + 5], R.list[e[t + 6]], !0, e[t + 7] >= 0 ? {
        sid: e[t + 7]
    } : null), t += 8
}

function Kf(e, t) {
    y = Vo(t), y && (y.xWiggle += T.gatherWiggle * Math.cos(e), y.yWiggle += T.gatherWiggle * Math.sin(e))
}

function Jf(e, t) {
    y = Vo(e), y && (y.dir = t, y.xWiggle += T.gatherWiggle * Math.cos(t + Math.PI), y.yWiggle += T.gatherWiggle * Math.sin(t + Math.PI))
}
...
function eu(e) {
    ...
    if (e) {
        const i = Date.now();
        for (var t = 0; t < e.length;) y = Fo(e[t]), y ? (y.index = e[t + 1], y.t1 = y.t2 === void 0 ? i : y.t2, y.t2 = i, y.x1 = y.x, y.y1 = y.y, y.x2 = e[t + 2], y.y2 = e[t + 3], y.d1 = y.d2 === void 0 ? e[t + 4] : y.d2, y.d2 = e[t + 4], y.health = e[t + 5], y.dt = 0, y.visible = !0) : (y = rr.spawn(e[t + 2], e[t + 3], e[t + 4], e[t + 1]), y.x2 = y.x, y.y2 = y.y, y.d2 = y.dir, y.health = e[t + 5], rr.aiTypes[e[t + 1]].name || (y.name = T.cowNames[e[t + 6]]), y.forcePos = !0, y.sid = e[t], y.visible = !0), t += 7
    }
}
const Or = {};
...
function tu(e, t) {
    ...
    if (!s) {
        ...
        n.onload = function() {
            this.isLoaded = !0, this.onload = null
        }, n.src = "./img/animals/" + e.src + ".png", s = n, Or[i] = s
    }
    if (s.isLoaded) {
...
function iu(e, t) {
    let i = lu(e[0]);
    i || (i = new Hc(e[0], e[1], T, C, go, ue, J, ye, R, Xt, Gt), J.push(i)), i.spawn(t ? vi : null), i.visible = !1, i.x2 = void 0, i.y2 = void 0, i.setData(e), t && (E = i, Re = E.x, _e = E.y, Mo(), Ro(), Bo(), _o(0), hs.style.display = "block")
}
...
function au(e) {
    ...
    for (var i = 0; i < e.length;) y = _i(e[i]), y && (y.t1 = y.t2 === void 0 ? t : y.t2, y.t2 = t, y.x1 = y.x, y.y1 = y.y, y.x2 = e[i + 1], y.y2 = e[i + 2], y.d1 = y.d2 === void 0 ? e[i + 3] : y.d2, y.d2 = e[i + 3], y.dt = 0, y.buildIndex = e[i + 4], y.weaponIndex = e[i + 5], y.weaponVariant = e[i + 6], y.team = e[i + 7], y.isLeader = e[i + 8], y.skinIndex = e[i + 9], y.tailIndex = e[i + 10], y.iconIndex = e[i + 11], y.zIndex = e[i + 12], y.visible = !0), i += 13
}

function lu(e) {
    for (let t = 0; t < J.length; ++t)
        if (J[t].id == e) return J[t];
    return null
}

function _i(e) {
    for (let t = 0; t < J.length; ++t)
        if (J[t].sid == e) return J[t];
    return null
}

function Fo(e) {
    for (let t = 0; t < ye.length; ++t)
        if (ye[t].sid == e) return ye[t];
    return null
}

function Vo(e) {
    for (let t = 0; t < et.length; ++t)
        if (et[t].sid == e) return et[t];
    return null
}
let Lo = -1;
...
function cu() {
    const e = Date.now() - Lo;
    window.pingTime = e, Jt.innerText = "Ping: " + e + " ms"
}
let En;

function Uo() {
    En && clearTimeout(En), as() && (Lo = Date.now(), ee.send("0")), En = setTimeout(Uo, 2500)
}
...
function hu(e) {
    ...
    let i = e % 60;
    i = ("0" + i).slice(-2), fr.innerText = "Server restarting in " + t + ":" + i, fr.hidden = !1
}
...
function No() {
    It = Date.now(), be = It - sr, sr = It, Hf(), requestAnimFrame(No)
}
Yf();
No();
